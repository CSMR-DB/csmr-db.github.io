...
> = styled(Link)`
  ...
  border: ${(props: { color: ColorProperty }): BorderProperty<1> =>
...
const StyledLogoOrb: StyledComponent<
  typeof Link,
  any,
  { color: ColorProperty },
  never
> = styled(StyledLinkOrb)`
  height: '12rem';
  width: '12rem';
  padding: '2rem';
    ...
    <StyledNav>
        ...
        (route: IRouteObject, i: number): JSX.Element => (
          <Tween
            ...
            from={
              currentPage === '/'
                ? {
                    boxShadow: `0 0 0 16rem inset ${theme.primary}`,
                    opacity: 0,
                    scale: 0,
                    y: `${(i + 1) * 100}px`,
                  }
      ...
      <Tween
        from={
          currentPage === '/'
            ? {
                boxShadow: `0 0 0 32rem inset ${theme.primary}`,
                opacity: 0,
                scale: 0,
              }
            : {}
