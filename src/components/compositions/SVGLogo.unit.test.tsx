...
describe('SVGLogo', (): void => {
  ...
  it('should render internally', (): void => {
    ...
    expect(comp.find(Filter).length).toEqual(1)
    expect(comp.find(Filter).props()).toMatchObject({
      $lens: 'transparent',
    })
    expect(comp.find(Filter).find(RandomSampleSVG).length).toEqual(1)
  })
})
